...
let songs = [
    ...
    },
    {
        ...
        artist: "Dilaw",
        album: "Sansinukob",
        albumArtUrl: "https://i.ytimg.com/vi/Q4h59M4F22k/maxresdefault.jpg",
    ...
    },
    {
        ...
        albumArtUrl: "https://upload.wikimedia.org/wikipedia/en/3/3c/The_1975_-_Being_Funny_in_a_Foreign_Language.png",
        audioSrc: "audio/about_you.mp3",
        videoBgSrc: "videos/about_you_bg.mp4",
        lyrics: [
            { time: 18.2, text: "I know a place" },
            { time: 22.2, text: "It's somewhere I go when I'm alone" },
            { time: 26.2, text: "I know a place" },
            { time: 30, text: "It's somewhere you'd say is pretty weird" },
            { time: 34.6, text: "I know a place" },
            { time: 38.6, text: "It's somewhere I go when I'm alone" },
            { time: 43.1, text: "And I know you'd love it there" },
            { time: 47, text: "So I'm not gonna take you there" },
            { time: 51.5, text: "There's a plane that's landin'" },
            { time: 55.4, text: "On the strip, it's a 757" },
            { time: 59.5, text: "There's a place I know" },
            { time: 103.4, text: "It's a place I go when I'm alone" },
            { time: 107.5, text: "I know a place" },
            { time: 111.4, text: "It's a place I go when I'm alone" },
            { time: 116, text: "And I know you'd love it there" },
            { time: 119.8, text: "So I'm not gonna take you there" },
            { time: 124.5, text: "Do you think I have forgotten?" },
            { time: 128.6, text: "Do you think I have forgotten?" },
            { time: 132.8, text: "Do you think I have forgotten about you?" },
            { time: 142.1, text: "You and I were alive" },
            { time: 146.1, text: "With the G.O.Y.A. in our eyes" },
            { time: 150.1, text: "I was goin' on about my life" },
            { time: 154, text: "And you said, \"I've been so worried 'bout you\"" },
            { time: 158.6, text: "I thought I'd lived a thousand lives" },
            { time: 202.6, text: "And I don't wanna die" },
            ...
            { time: 218.1, text: "Do you think I have forgotten?" },
            { time: 222.2, text: "Do you think I have forgotten about you?" },
            { time: 228.2, text: "I'm sure that you're drinkin'" },
            { time: 232.2, text: "I'm sure that you're drinkin'" },
            { time: 236.2, text: "I'm sure that you're drinkin' about you" },
            { time: 240.5, text: "(Do you think I have forgotten about you?)" },
            { time: 245, text: "I'm sure that you're thinkin'" },
            { time: 249, text: "I'm sure that you're thinkin'" },
            { time: 253, text: "I'm sure that you're thinkin' about you" },
            { time: 257.5, text: "(Do you think I have forgotten about you?)" }
        ]
    }
];
