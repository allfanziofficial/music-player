...
let songs = [
    ...
    },
    {
        ...
        audioSrc: "audio/multo.mp3", // Pastikan nama file audio sesuai
        videoBgSrc: "videos/multo.mp4", // Pastikan nama file video sesuai
        lyrics: [
            ...
            { time: 37, text: "Pinapanood ang iyong bawat galaw" },
            { time: 40, text: "Habang ako'y nalulunod sa 'yong mga tingin" },
            { time: 44, text: "Pilitin ma'y 'di makawala sa'yo" },
            { time: 47, text: "Bakit ba naman kasi ganito?" },
            { time: 51, text: "'Di na mapakali, 'di na mapalagay" },
            { time: 57, text: "Ang puso kong ito'y bihag mo na, sinta" },
            { time: 61, text: "Para bang multo, 'di maalis sa isipan ko" },
            ...
            { time: 92, text: "Isang multo ng nakaraan, 'di makalimutan" },
            { time: 99, text: "Nagpaparamdam, ngunit 'di na mababalikan" },
            { time: 104, text: "Pinapanood ang iyong bawat galaw" },
            { time: 107, text: "Habang ako'y nalulunod sa 'yong mga tingin" },
            { time: 111, text: "Pilitin ma'y 'di makawala sa'yo" },
            { time: 115, text: "Bakit ba naman kasi ganito?" },
            { time: 118, text: "'Di na mapakali, 'di na mapalagay" },
            { time: 124, text: "Ang puso kong ito'y bihag mo na, sinta" },
            { time: 129, text: "Para bang multo, 'di maalis sa isipan ko" },
            { time: 135, text: "Ang 'yong mukha, ang 'yong ngiti, ang lahat sa 'yo" },
            { time: 142, text: "Bakit ba ganito? Bakit ba lagi kang nandito?" },
            { time: 146, text: "Sa bawat sulok ng aking mundo" },
            { time: 149, text: "Isang multo, isang multo" },
            { time: 153, text: "Bakit ba ganito? Bakit ba lagi kang nandito?" },
            { time: 157, text: "Sa bawat sulok ng aking mundo" },
            { time: 160, text: "Isang multo, isang multo ka" },
            { time: 165, text: "'Di na mapakali, 'di na mapalagay" },
            { time: 171, text: "Ang puso kong ito'y bihag mo na, sinta" },
            { time: 175, text: "Para bang multo, 'di maalis sa isipan ko" },
            { time: 182, text: "Ang 'yong mukha, ang 'yong ngiti, ang lahat sa 'yo" },
        ]
    },
    // LAGU BARU DITAMBAHKAN DI SINI
    {
        ...
        audioSrc: "audio/aboutyou.mp3", // Pastikan nama file audio sesuai
        videoBgSrc: "videos/about.mp4", // Pastikan nama file video sesuai
        lyrics: [
            { time: 18.5, text: "I know a place" },
            { time: 22.5, text: "It's somewhere I go when I'm alone" },
            { time: 26.5, text: "I know a place" },
            { time: 30.5, text: "It's somewhere you'd say is pretty weird" },
            { time: 35, text: "I know a place" },
            { time: 39, text: "It's somewhere I go when I'm alone" },
            { time: 43.5, text: "And I know you'd love it there" },
            { time: 47.5, text: "So I'm not gonna take you there" },
            { time: 51.5, text: "There's a plane that's landin'" },
            { time: 55.5, text: "On the strip, it's a 757" },
            { time: 59.5, text: "There's a place I know" },
            { time: 103.5, text: "It's a place I go when I'm alone" },
            { time: 108, text: "I know a place" },
            { time: 111.5, text: "It's a place I go when I'm alone" },
            { time: 116.5, text: "And I know you'd love it there" },
            { time: 120.5, text: "So I'm not gonna take you there" },
            { time: 125, text: "Do you think I have forgotten?" },
            { time: 129, text: "Do you think I have forgotten?" },
            { time: 133, text: "Do you think I have forgotten about you?" },
            { time: 142.5, text: "You and I were alive" },
            { time: 146.5, text: "With the G.O.Y.A. in our eyes" },
            { time: 150.5, text: "I was goin' on about my life" },
            { time: 154.5, text: "And you said, \"I've been so worried 'bout you\"" },
            { time: 159, text: "I thought I'd lived a thousand lives" },
            { time: 203, text: "And I don't wanna die" },
            { time: 206.5, text: "But I've got no spiritual guide" },
            { time: 210.5, text: "And I'm not surprised" },
            { time: 214.5, text: "Do you think I have forgotten?" },
            { time: 218.5, text: "Do you think I have forgotten?" },
            { time: 222.5, text: "Do you think I have forgotten about you?" },
            { time: 228.5, text: "I'm sure that you're drinkin'" },
            { time: 232.5, text: "I'm sure that you're drinkin'" },
            { time: 236.5, text: "I'm sure that you're drinkin' about you" },
            { time: 241, text: "(Do you think I have forgotten about you?)" },
            { time: 245.5, text: "I'm sure that you're thinkin'" },
            { time: 249.5, text: "I'm sure that you're thinkin'" },
            { time: 253.5, text: "I'm sure that you're thinkin' about you" },
            { time: 258, text: "(Do you think I have forgotten about you?)" }
        ]
    }
];
